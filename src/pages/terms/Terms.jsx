...
const terms = [
  {
    ...
    description:
      "Please read these terms of service carefully before using DMETR API website operated by DMETR Team.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Content published on this website (digital downloads, images, texts, graphics, logos) is the property of DMETR and/or its content creators and protected by international copyright laws. The entire compilation of the content found on this website is the exclusive property of DMETR, with copyright authorship for this compilation by DMETR.",
  },
  {
  ...
  },
  {
    ...
    description:
      "By visiting this website, you agree that the laws of the [your location], without regard to principles of conflict laws, will govern these terms of service, or any dispute of any sort that might come between DMETR and you, or its business partners and associates.",
  },
  {
    title: "Disputes",
    description:
  ...
  },
  {
    ...
    description:
      "Visitors may post content as long as it is not obscene, illegal, defamatory, threatening, infringing of intellectual property rights, invasive of privacy or injurious in any other way to third parties. Content has to be free of software viruses, political campaign, and commercial solicitation. We reserve all rights (but not the obligation) to remove and/or edit such content. When you post your content, you grant DMETR non-exclusive, royalty-free and irrevocable right to use, reproduce, publish, modify such content throughout the world in any media.",
  },
  {
